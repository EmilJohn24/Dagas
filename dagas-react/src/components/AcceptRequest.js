      ...
      <DashboardNavbar />
        <MDBox p={10}>
          <Grid spacing={3} p={2} container style={{backgroundColor: '#ffffff' }}>
            ...
            <Grid xs={1} container justifyContent="center" className="PaddingsText">
              {/* <img src="../assets/images/drake.jpg" alt="Italian Trulli"  width="50%" height="50%"/> */}
              <FastfoodIcon></FastfoodIcon>
            </Grid>
            <Grid xs={4} container justifyContent="center" className="PaddingsText">
              <MDTypography variant="h5" fontWeight="medium">
                  Food
              </MDTypography>
            </Grid>
            <Grid xs={7} className="Paddings"> 
